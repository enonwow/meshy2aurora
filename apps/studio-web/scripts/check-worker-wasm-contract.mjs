...
const expectedRequests = [
  ...
  "INSPECT_ANIMATION_TRANSFER_COMPATIBILITY",
  "RETARGET_ANIMATION_MODEL_CLIP",
  "INSPECT_HUMANOID_RETARGET_COMPATIBILITY_V2",
  "RETARGET_ANIMATION_CLIP_HUMANOID_V2",
  "PREPARE_ANIMATION_TRANSFER_BATCH_V2",
  "BUILD_ANIMATION_SEQUENCE_PREVIEW",
  "APPLY_ANIMATION_WORKBENCH_OPERATION_V1",
  "RESAMPLE_ANIMATION_CURVE_TO_LINEAR",
  ...
  "APPLY_ANIMATION_EDIT_COMMAND_BATCH",
  "ANALYZE_ANIMATION_MOTION_QUALITY",
  "APPLY_ANIMATION_AUTHORING_TOOL",
  "INSPECT_HELD_WEAPON_SOURCE",
  "EVALUATE_ANIMATION_POSE_PARITY",
  "VALIDATE_ANIMATION_PRESET",
  "INSPECT_ANIMATION_PRESET_COMPATIBILITY",
  "INSTANTIATE_ANIMATION_PRESET",
  "EXPORT_ANIMATION_CONTRIBUTION",
  "BUILD_MODEL_PACKAGE",
