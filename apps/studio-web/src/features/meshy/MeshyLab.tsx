...
export function MeshyLab({ bridge, onBack, onImport }: MeshyLabProps) {
  ...
  const canReview = generationSource === "TEXT" ? Boolean(prompt.trim()) : Boolean(imageInputTaskId || referenceImages.length > 0);
