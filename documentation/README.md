...
- [Implementacja 10 funkcji rozwoju animacji — evidence (2026-08-01)](evidence/animation-10-functions-implementation-2026-08-01.md)
...
- Jeden budzet produktu dla Creature, Placeable i pozostalych render modeli to `AURORA_MODEL_TRIANGLE_BUDGET_V1 = 300_000`: warning powyzej 150 000, blokada dopiero powyzej 300 000. Granica formatu jednego strumienia MDL 21 845 pozostaje osobna.
...
- [evidence/shared-render-model-triangle-budget-20000-2026-07-27.md](evidence/shared-render-model-triangle-budget-20000-2026-07-27.md) - historyczna, zastapiona 2026-07-29 decyzja o budzecie 300 000; zachowana dla provenance dawnych lineage.
...
- [void-crystal-knight-authored-sword-slash-2026-07-30.md](void-crystal-knight-authored-sword-slash-2026-07-30.md) - prawdziwy preset `HUMANOID_SWORD_SLASH` w Animation Studio: 12 animowanych kości, sześć faz ataku, routing ONE_SHOT do trzech natywnych stanów walki i exact V5/binary readback dla Void Crystal Knighta.
- [evidence/void-crystal-knight-vckattack1-ready-for-owner-proof-2026-07-30.md](evidence/void-crystal-knight-vckattack1-ready-for-owner-proof-2026-07-30.md) - świeże demo `vckattack1.mod`/`.hak` z nienaruszonym idle, tym samym autorskim ciosem w `ca1slashl`/`ca1slashr`/`ca1stab`, hashami instalacji i instrukcją proofu właściciela w NWN.
...
- [audyt-poprawki-rozwiazan-animacji-2026-07-30.md](audyt-poprawki-rozwiazan-animacji-2026-07-30.md) - autorytatywny stan poprawek po czterech audytach: donor import i race gates, weighted H1 GLB readback, task ledger/koszty, ONE_SHOT attack demo, exact Custom provenance, owner proof registry, kuratowany katalog Meshy, `texture_resolution`, budzet 300K i zapas CSS.
- [community-animation-library-2026-07-31.md](community-animation-library-2026-07-31.md) - zaakceptowany projekt repozytoryjnej biblioteki `Built-in`/`Community`/`Custom`: wersjonowane paczki animacji, tagi, wyszukiwanie, PR-y contributorów, walidacja CI, build-time catalog oraz opcjonalne podpisane aktualizacje.
- [audyt-plan-biblioteki-animacji-2026-07-31.md](audyt-plan-biblioteki-animacji-2026-07-31.md) - wykonawczy audyt stanu kodu, priorytety P0-P2, przenośny kontrakt presetów, szczegółowy plan faz F0-F8, funkcje do implementacji oraz binarne kryteria ukończenia K0-K10.
- [animation-library-implementation-evidence-2026-07-31.md](animation-library-implementation-evidence-2026-07-31.md) - stan wdrożenia faz F0-F8 i kryteriów K0-K10, wyniki bramek, hashe siedmiu presetów startowych oraz jawnie otwarte decyzje właścicielskie.
- [animation-studio-library-provenance-migration-v2-2026-07-31.md](animation-studio-library-provenance-migration-v2-2026-07-31.md) - wersjonowana migracja dokumentu Animation Studio V1→V2 wymagana przez `LIBRARY_PRESET_COPY`, wraz z regułami kompatybilności i integralności.
- [plan-retargetingu-animacji-miedzy-modelami-2026-07-31.md](plan-retargetingu-animacji-miedzy-modelami-2026-07-31.md) - wykonawczy plan `SAME_HIERARCHY_RETARGET_V1` dla kopiowania ruchu między modelami o tej samej hierarchii i różnym rest pose; zawiera kontrakt Core/WASM/Worker/Studio, fazy F0-F8 oraz binarne kryteria K0-K10 oparte na exact Fogbound → Void Knight.
- [evidence/fogbound-to-void-knight-retarget-v1-offline-2026-07-31.md](evidence/fogbound-to-void-knight-retarget-v1-offline-2026-07-31.md) - wdrożony przepływ Core/WASM/Worker/Studio, dokładny retarget `ca1slashl` z Fogbounda do Void Knighta, fingerprinty i zielone bramki offline; bez MOD/HAK i bez claimu runtime.
- [audyt-animacji-dalsze-usprawnienia-2026-07-31.md](audyt-animacji-dalsze-usprawnienia-2026-07-31.md) - świeży audyt po wdrożeniu płynnego playbacku, biblioteki i retargetingu: luki authoringu, pose parity, quality analyzer, prawdziwy gizmo 3D, pętle/root motion, broń w dłoni, batch transfer, fazy F0-F8 i binarne kryteria kolejnego milestone'u.
- [plan-implementacji-animation-authoring-v2-2026-07-31.md](plan-implementacji-animation-authoring-v2-2026-07-31.md) - wykonawczy plan Animation Authoring V2: fazy F0-F9, zależności, konkretne funkcje Core/WASM/Worker/Studio, TDD, held weapon, retarget V2, warstwy/krzywe oraz binarne kryteria K0-K14 rozdzielające offline product complete od owner runtime verified.
- [animation-authoring-v2-implementation-evidence-2026-07-31.md](animation-authoring-v2-implementation-evidence-2026-07-31.md) - bieżący stan wdrożenia Core/WASM/Worker/Studio, zielone bramki i jawne luki: finalny weapon product build, manual mapping UI, batch UI, persistence warstw oraz packaged parity.
- [audyt-10-funkcji-rozwoju-animacji-2026-08-01.md](audyt-10-funkcji-rozwoju-animacji-2026-08-01.md) - audyt dziesięciu kolejnych funkcji Animation Studio: finalna broń, fazy ataku, pose tools, graph editor, trails/onion skin, sequence composer, manual retarget, batch, warianty/tagi i combat quality; zawiera fazy F0-F9 oraz binarne kryteria K0-K12.
- [evidence/animation-audit-fixes-owner-proof-gate-2026-07-30.md](evidence/animation-audit-fixes-owner-proof-gate-2026-07-30.md) - dokładny handoff obecnego Void Crystal Knight do decyzji właściciela; jawnie oddziela historyczny packet z `cpause1` override od jeszcze niematerializowanego, poprawionego routingu ataku.
