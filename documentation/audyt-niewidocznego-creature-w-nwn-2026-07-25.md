...
| `IMPL-18` | Completeness report | Historyczny V1 zapisywał `explicitClipCount=42`. Od 2026-07-28 zastępuje go V2 z rozdzielonym `preservedSourceClipCount`, `sourceDerivedClipCount`, `proceduralClipCount`, listą `discardedSourceClips`, `fallbackAliasCount=0` i `complete=true`. |
