...
const SOURCE_PATH: &str =
    r"C:\Projects\meshy2aurora\sample-3d\concept-medieval-ship-s1-p100k-v1\source.glb";
const SOURCE_SHA256: &str = "9ed47edca7765888ca0e034455ba4302a88fa700a72004cbdbee29f311e58ced";
const REFERENCE_IMAGE_SHA256: &str =
...
const OUTPUT_PATH: &str =
    r"C:\Projects\meshy2aurora\proof-output\concept-medieval-ship-placeable-v1-20260731";
const NATIVE_MOD_PATH: &str =
    r"C:\Users\enonw\Documents\Neverwinter Nights\modules\m2a_ship1_mod.mod";
const NATIVE_HAK_PATH: &str = r"C:\Users\enonw\Documents\Neverwinter Nights\hak\m2a_ship1_hak.hak";
const SHIP_SCALE: f32 = 8.0;
const SOURCE_MIN_Z: f32 = -0.518_903;
...
fn run() -> Result<String, String> {
    ...
    let identity = StaticPlaceableIdentityV1 {
        module_resref: "m2a_ship1_mod".to_owned(),
        module_file_name: "m2a_ship1_mod.mod".to_owned(),
        module_display_name: "Meshy2Aurora Medieval Ship Demo".to_owned(),
        area_resref: "m2a_ship1_ar".to_owned(),
        area_name: "Meshy2Aurora Medieval Ship Harbor".to_owned(),
        hak_resref: "m2a_ship1_hak".to_owned(),
        hak_file_name: "m2a_ship1_hak.hak".to_owned(),
        model_resref: "m2a_ship1_mdl".to_owned(),
        texture_resref: "m2a_ship1_tex".to_owned(),
        blueprint_resref: "m2a_ship1_utp".to_owned(),
        object_tag: "m2a_ship1_medieval_ship".to_owned(),
        display_name: "Meshy Medieval Ship".to_owned(),
    };
    ...
    element.transform.translation = [0.0, 0.0, -SOURCE_MIN_Z * SHIP_SCALE];
    ...
    if dimensions[0] < 12.0 || dimensions[1] < 6.0 || dimensions[2] < 8.0 {
        return Err(format!(
    ...
    let geometry_readback = json!({
        "schemaVersion": 1,
        "sourceMeshyTriangles": 99_432,
        "auroraSafeTriangles": authoring.output_triangle_count,
        "removedDegenerateTriangles": 99_432_u32 - authoring.output_triangle_count,
    ...
    let handoff = json!({
        ...
        "source": {
            ...
            "meshyRunId": "d6ffe618-e08b-4c41-ad25-a73b941efbe3",
            "meshyTaskId": "019fb8fb-896a-7219-bb1d-b566c1c8f1d7",
            "requestedPolycount": 100_000,
            "generatedTriangles": 99_432,
            "manualMeshOrTextureEdits": false,
        },
