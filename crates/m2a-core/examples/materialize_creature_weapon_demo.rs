...
use m2a_core::{
    creature_equipment::{
        AURORA_LEFT_HAND_ANCHOR_V1, AURORA_RIGHT_HAND_ANCHOR_V1,
        MESHY_H1_HAND_ANCHOR_CALIBRATION_V1,
    },
    inspect_binary_mdl,
    mdl::NodeReport,
    model_pipeline::{
...
const MODULE_RESREF: &str = "m2aweapdemo7";
const AREA_RESREF: &str = "m2aweaparea7";
const HAK_RESREF: &str = "m2aweaphak7";
const MODEL_RESREF: &str = "m2aweapcre7";
const TEXTURE_RESREF: &str = "m2aweaptex7";
const RIGHT_CREATURE_RESREF: &str = "m2awrhand7";
const WEAPON_RESREF: &str = "m2aweapitem7";
const MODULE_DISPLAY_NAME: &str = "Meshy2Aurora Creature Weapon Grip V7";
const AREA_DISPLAY_NAME: &str = "Meshy2Aurora Creature Weapon Test V7";
...
fn run() -> Result<String, String> {
    ...
    let identity = ProceduralCreatureProductIdentityV2 {
        ...
        appearance_label: "M2A_CREATURE_WEAPON_GRIP_V7".to_owned(),
    };
    ...
    let weapon = BinaryCreatureWeaponItemV1::owned_standard_longsword_v2(WEAPON_RESREF);
    ...
    let fixtures = vec![make_fixture(
        ...
        "V7 RIGHT HAND - module-local UTI longsword - native basis",
        BinaryCreatureHandSlotV1::RightHand,
        10.0,
    )];
    let module = build_binary_creature_owned_weapon_demo_module_named_v2(
        &module_identity,
        &fixtures,
        &weapon,
        MODULE_DISPLAY_NAME,
        AREA_DISPLAY_NAME,
        "Generated by Meshy2Aurora to test a real module-local UTI longsword on the V7 palm-center and native-item-basis Creature weapon grip.",
    )
    ...
    let handoff = serde_json::json!({
        ...
        "purpose": "CREATURE_MODULE_LOCAL_UTI_PALM_CENTER_NATIVE_ITEM_BASIS_DEMO_V7",
        ...
        "weaponGripCalibration": MESHY_H1_HAND_ANCHOR_CALIBRATION_V1,
        "weaponResourceScope": "MODULE_LOCAL_UTI",
