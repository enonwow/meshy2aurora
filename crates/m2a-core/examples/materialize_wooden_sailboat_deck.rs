...
use m2a_core::{
    erf::ErfArchive,
    mdl::{NWN_EE_MAX_MESH_TRIANGLE_COUNT_V1, ParserLimits, inspect_binary_mdl_with_limits},
    placeable::{
        ARE_RESOURCE_TYPE, FAC_RESOURCE_TYPE, GIC_RESOURCE_TYPE, GIT_RESOURCE_TYPE,
        IFO_RESOURCE_TYPE, ITP_RESOURCE_TYPE, MDL_RESOURCE_TYPE,
        OWNER_APPROVED_OVERSIZED_PLACEABLE_SCHEMA_VERSION, OwnerApprovedOversizedPlaceableV1,
        ...
        build_meshy_static_placeable_package_with_oversized_exception_v3,
...
const SOURCE_PATH: &str =
    r"C:\Projects\meshy2aurora\sample-3d\wooden-sailboat-deck-s2-textured-v1\source.glb";
const SOURCE_SHA256: &str = "5085db9399eb7d30ddcb6c65b51748f4cabc5ed10cdf7ba912cdf2ef62e1dabe";
const SOURCE_TRIANGLES: u32 = 1_971_350;
...
const OUTPUT_PATH: &str =
    r"C:\Projects\meshy2aurora\proof-output\wooden-sailboat-deck-placeable-preserve-v2-20260731";
const NATIVE_MOD_PATH: &str =
    r"C:\Users\enonw\Documents\Neverwinter Nights\modules\m2a_ship3_mod.mod";
const NATIVE_HAK_PATH: &str = r"C:\Users\enonw\Documents\Neverwinter Nights\hak\m2a_ship3_hak.hak";
...
fn run() -> Result<String, String> {
    ...
    let oversized_exception = OwnerApprovedOversizedPlaceableV1 {
        schema_version: OWNER_APPROVED_OVERSIZED_PLACEABLE_SCHEMA_VERSION,
        exact_source_sha256: SOURCE_SHA256.to_owned(),
        authorization_note: "Owner instruction 2026-07-31: preserve valid microtriangles with aggressive cleanup disabled and admit up to 2000000 output triangles for exact source SHA 5085db9399eb7d30ddcb6c65b51748f4cabc5ed10cdf7ba912cdf2ef62e1dabe; preserve default product limits for every other source".to_owned(),
        max_input_bytes: 128 * 1024 * 1024,
        max_vertices: 2_000_000,
        max_indices: 6_000_000,
        max_decoded_geometry_bytes: 512 * 1024 * 1024,
        max_triangles: 2_000_000,
        max_profile_work_bytes: 2 * 1024 * 1024 * 1024,
        max_hak_output_bytes: 256 * 1024 * 1024,
    };

    let identity = StaticPlaceableIdentityV1 {
        module_resref: "m2a_ship3_mod".to_owned(),
        module_file_name: "m2a_ship3_mod.mod".to_owned(),
        module_display_name: "Meshy2Aurora Wooden Sailboat Preserve Demo".to_owned(),
        area_resref: "m2a_ship3_ar".to_owned(),
        area_name: "Meshy2Aurora Wooden Sailboat Preserve Harbor".to_owned(),
        hak_resref: "m2a_ship3_hak".to_owned(),
        hak_file_name: "m2a_ship3_hak.hak".to_owned(),
        model_resref: "m2a_ship3_mdl".to_owned(),
        texture_resref: "m2a_ship3_tex".to_owned(),
        blueprint_resref: "m2a_ship3_utp".to_owned(),
        object_tag: "m2a_ship3_wooden_sailboat".to_owned(),
        display_name: "Meshy Wooden Sailboat".to_owned(),
    };
    ...
    let mut bootstrap = inspect_meshy_static_placeable_authoring_with_oversized_exception_v1(
        &source,
        &oversized_exception,
    )
    ...
    let artifact = build_meshy_static_placeable_package_with_oversized_exception_v3(
        &source,
        &base_placeables,
        &identity,
        placement,
    ...
    let mdl_inspection = inspect_binary_mdl_with_limits(
        mdl,
        &ParserLimits {
    ...
    .map_err(|error| format!("SHIP-DEMO-MDL-READBACK: {error}"))?;
    ...
    let geometry_readback = json!({
        ...
        "ownerApprovedOversizedException": &oversized_exception,
    });
    ...
    let handoff = json!({
        ...
        "source": {
            ...
            "originalFileName": "Meshy_AI_Wooden_Sailboat_Deck__0731170742_texture.glb",
            "meshyGenerator": "meshy-scene",
            "requestedPolycount": null,
